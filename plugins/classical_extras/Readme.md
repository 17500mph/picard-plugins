# General Information
This is the documentation for version 0.9.3 of "classical\_extras". There may be beta versions later than this - check [my github site](https://github.com/MetaTunes/picard-plugins/releases) for newer releases. For further help, please review [the forum thread](https://community.metabrainz.org/t/classical-extras-plugin/300217) or post any new questions there. 
